...
const Functions = () => {
  return (
    <ServicesContainer id='services'>
      ...
      <ServicesWrapper>
      <LinkR to ='/customer' style = {{textDecoration:'none', color:'var(--primary-green)'}}>
        <ServicesCard>
        ...
        <LinkR to ='/bills' style = {{textDecoration:'none', color:'var(--primary-green)'}}>
        <ServicesCard>
        ...
        <LinkR to ='/medicine' style = {{textDecoration:'none', color:'var(--primary-green)'}}>
        <ServicesCard>
